...
public class ProgramEditController implements Initializable {
    ...
    @FXML
    private AnchorPane anchorPaneJournalNotes;
    ...
    // program edit
    @FXML
    private Label lblProgramEditHeader;
            ...
            if (!programList.isEmpty()) {
                ...
                for (ProgramData pd : programList) {
                    ...
                    label.setOnMouseClicked((mouseEvent) -> {
                        ...
                        ProgramHolder.setProgramName(pd.getProgramName());
                ...
                lblTemp.setText("Det finns inga program");
            }
    ...
    public void showProgramEdit() {
        try {
            AnchorPane paneProgramEdit = FXMLLoader.load(getClass().getResource("/programEdit/programEdit.fxml"));
            anchorPaneJournalNotes.getChildren().setAll(paneProgramEdit);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // set program header
        lblProgramEditHeader.setText(ProgramHolder.getProgramName());
    } */
}
